 ...
 * Use the [StudentBasicDetailsActivity.newInstance] factory method to
...
class StudentBasicDetailsActivity : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment StudentBasicDetailsActivity.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic fun newInstance(param1: String, param2: String) =
                StudentBasicDetailsActivity().apply {
